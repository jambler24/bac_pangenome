...
process '2A_read_mapping' {
  ...
  script:
  """
  bwa mem $genome $forwardTrimmed $reverseTrimmed > sample_${sampleNumber}_aln.bam
  samtools sort sample_${sampleNumber}_aln.bam -o sample_${sampleNumber}_sorted.bam
